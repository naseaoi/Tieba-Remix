...
}.images-viewer .head-controls .head-btn.toggle-on[data-v-17710c27] {
...
.images-viewer .icon[data-v-17710c27] {
  color: var(--light-fore);
}
.images-viewer .control-panel[data-v-17710c27] {
...
html.dark-theme .images-viewer .control-panel[data-v-17710c27] {
  -webkit-backdrop-filter: blur(24px) brightness(0.8);
          backdrop-filter: blur(24px) brightness(0.8);
}
.images-viewer .head-controls[data-v-17710c27] {
  top: 16px;
  margin-bottom: auto;
  transition: var(--default-duration);
}
.images-viewer .head-controls.hide[data-v-17710c27] {
  box-shadow: none;
  transform: translateY(calc(-100% - 16px)) scale(0.85);
}
.images-viewer .head-controls .head-btn[data-v-17710c27] {
  width: 36px;
  height: 36px;
  padding: 0;
  border-radius: 12px;
...
.images-viewer .head-controls .head-btn[data-v-17710c27]:hover {
  background-color: var(--default-background);
...
.images-viewer .head-controls .head-btn.toggle-on[data-v-17710c27]:hover {
  filter: brightness(1.2);
}
.images-viewer .head-controls .close[data-v-17710c27]:hover {
  color: var(--error-color);
}
.images-viewer .head-controls span[data-v-17710c27] {
  color: var(--minimal-fore);
  font-family: var(--code-monospace);
}
.images-viewer .head-controls .zoom-size[data-v-17710c27] {
  padding: 10px;
}
.images-viewer .back[data-v-17710c27],
.images-viewer .forward[data-v-17710c27] {
...
.images-viewer .back.hide[data-v-17710c27] {
  box-shadow: none;
...
.images-viewer .forward.hide[data-v-17710c27] {
  box-shadow: none;
  transform: translateX(calc(100% + 32px)) scale(0.85);
}
.images-viewer .back[data-v-17710c27]:hover,
.images-viewer .forward[data-v-17710c27]:hover {
  background-color: var(--default-background);
}
.images-viewer .back[data-v-17710c27]:focus,
.images-viewer .forward[data-v-17710c27]:focus {
  box-shadow: 0 0 0 2px var(--tieba-theme-color);
}
.images-viewer .image-container[data-v-17710c27] {
  position: relative;
  display: flex;
  width: 100%;
  height: 100%;
...
.images-viewer .image-container .curr-image[data-v-17710c27] {
  position: absolute;
  -o-object-fit: contain;
     object-fit: contain;
  transition: opacity 0.2s ease;
}
.images-viewer .image-container .curr-image.loading-img[data-v-17710c27] {
  opacity: 0;
}
.images-viewer .image-container .curr-image.changing[data-v-17710c27] {
  transition: none !important;
}
.images-viewer .image-container .image-loading-spinner[data-v-17710c27] {
  position: absolute;
  width: 48px;
  height: 48px;
  ...
  border-radius: 50%;
  animation: kf-spin-17710c27 0.8s linear infinite;
  pointer-events: none;
}
@keyframes kf-spin-17710c27 {
to {
    transform: rotate(360deg);
}
}
.images-viewer .bottom-controls-wrapper[data-v-17710c27] {
  bottom: 16px;
...
.images-viewer .bottom-controls-wrapper.hide[data-v-17710c27] {
  box-shadow: none;
  transform: translateY(calc(100% + 16px)) scale(0.85);
}
.images-viewer .bottom-controls-wrapper:hover .bottom-panel-scroll-bar[data-v-17710c27] {
  opacity: 1;
}
.images-viewer .bottom-controls-wrapper .bottom-controls-container[data-v-17710c27] {
  display: flex;
  overflow: hidden;
  padding: 10px;
}
.images-viewer .bottom-controls-wrapper .bottom-controls-container img[src=""][data-v-17710c27],
.images-viewer .bottom-controls-wrapper .bottom-controls-container img[data-v-17710c27]:not([src]) {
  opacity: 0;
}
.images-viewer .bottom-controls-wrapper .bottom-controls-container .thumb-container[data-v-17710c27] {
  display: flex;
  gap: 4px;
}
.images-viewer .bottom-controls-wrapper .bottom-controls-container .thumb-container .bottom-btn[data-v-17710c27] {
  overflow: hidden;
  width: 100px;
  height: 75px;
  padding: 0;
...
.images-viewer .bottom-controls-wrapper .bottom-controls-container .thumb-container .bottom-btn .image-list[data-v-17710c27] {
  width: 100%;
  height: 100%;
  -o-object-fit: cover;
     object-fit: cover;
}
.images-viewer .bottom-controls-wrapper .bottom-controls-container .thumb-container .bottom-btn.selected[data-v-17710c27] {
  border: 3px solid var(--tieba-theme-color);
}
.images-viewer .bottom-controls-wrapper .bottom-panel-scroll-bar[data-v-17710c27] {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
html.style-vercel .images-viewer[data-v-17710c27] {
  --viewer-bg: #0A0A0A;
...
html.style-vercel .images-viewer .icon[data-v-17710c27] {
  color: var(--viewer-light-fore);
}
html.style-vercel .images-viewer .control-panel[data-v-17710c27] {
...
html.style-vercel .images-viewer .head-controls[data-v-17710c27] {
  border-radius: 8px;
}
html.style-vercel .images-viewer .head-controls.hide[data-v-17710c27] {
  box-shadow: none;
}
html.style-vercel .images-viewer .head-controls span[data-v-17710c27] {
  color: var(--viewer-light-fore);
}
html.style-vercel .images-viewer .head-controls .head-btn[data-v-17710c27] {
  border-radius: 6px;
  color: var(--viewer-light-fore);
}
html.style-vercel .images-viewer .head-controls .head-btn[data-v-17710c27]:hover {
  background-color: var(--viewer-bg-hover);
  color: var(--viewer-fore);
}
html.style-vercel .images-viewer .head-controls .head-btn.toggle-on[data-v-17710c27] {
  background-color: var(--viewer-accent);
  color: var(--viewer-bg);
}
html.style-vercel .images-viewer .head-controls .head-btn.toggle-on[data-v-17710c27]:hover {
  background-color: var(--viewer-accent);
  color: var(--viewer-bg);
  filter: none;
}
html.style-vercel .images-viewer .head-controls .close[data-v-17710c27]:hover {
  color: var(--error-color);
}
html.style-vercel .images-viewer .back[data-v-17710c27],
html.style-vercel .images-viewer .forward[data-v-17710c27] {
  border-radius: 8px;
  box-shadow: none;
  color: var(--viewer-light-fore);
}
html.style-vercel .images-viewer .back[data-v-17710c27]:hover,
html.style-vercel .images-viewer .forward[data-v-17710c27]:hover {
  background-color: var(--viewer-bg-hover);
  color: var(--viewer-fore);
}
html.style-vercel .images-viewer .back[data-v-17710c27]:focus,
html.style-vercel .images-viewer .forward[data-v-17710c27]:focus {
  box-shadow: 0 0 0 1px var(--viewer-accent);
}
html.style-vercel .images-viewer .bottom-controls-wrapper[data-v-17710c27] {
  border-radius: 8px;
}
html.style-vercel .images-viewer .bottom-controls-wrapper .bottom-controls-container .thumb-container .bottom-btn[data-v-17710c27] {
  border-radius: 4px;
  background-color: var(--viewer-bg-hover);
}
html.style-vercel .images-viewer .bottom-controls-wrapper .bottom-controls-container .thumb-container .bottom-btn.selected[data-v-17710c27] {
...
}.index-wrapper .grid-container .profile-menu-container .curr-user .user-profile[data-v-2a763b36] {
  -o-object-fit: contain;
     object-fit: contain;
}
a[data-v-2a763b36] {
...
.block-wrapper[data-v-2a763b36] {
  display: flex;
  flex-direction: column;
  gap: 8px;
}
.block-controls[data-v-2a763b36] {
  display: flex;
  width: 100%;
  align-items: center;
  gap: 8px;
}
.block-controls .block-title[data-v-2a763b36] {
  margin: 0;
  font-size: 24px;
  font-weight: var(--font-weight-bold);
}
.block-container[data-v-2a763b36] {
  padding: 8px;
  border-radius: 12px;
  background-color: var(--trans-light-background);
}
body.custom-background .block-container[data-v-2a763b36] {
  -webkit-backdrop-filter: blur(24px);
          backdrop-filter: blur(24px);
}
html.dark-theme body.custom-background .block-container[data-v-2a763b36] {
  -webkit-backdrop-filter: blur(24px) brightness(0.8);
          backdrop-filter: blur(24px) brightness(0.8);
}
.block-panel[data-v-2a763b36] {
  display: flex;
  min-width: 30px;
  height: 26px;
  align-items: center;
...
.block-panel .icon[data-v-2a763b36] {
  color: var(--light-fore);
  font-size: 18px;
}
.block-panel .panel-btn[data-v-2a763b36] {
  width: 30px;
  height: 30px;
  padding: 4px;
  border: none;
...
.block-panel.left-align[data-v-2a763b36] {
  margin-left: 0;
}
.index-wrapper[data-v-2a763b36] {
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 12px;
}
.index-wrapper .grid-container[data-v-2a763b36] {
  display: grid;
  max-width: var(--content-max);
  margin: 16px;
  grid-gap: 36px;
...
.index-wrapper .grid-container .head-controls[data-v-2a763b36] {
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 24px;
...
.index-wrapper .grid-container .head-controls .main-title[data-v-2a763b36] {
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 12px;
}
.index-wrapper .grid-container .head-controls .main-title .main-icon[data-v-2a763b36] {
  height: 64px;
}
.index-wrapper .grid-container .head-controls .main-title .title[data-v-2a763b36] {
  font-size: 36px;
  font-style: italic;
  font-weight: var(--font-weight-bold);
}
.index-wrapper .grid-container .head-controls .search-controls[data-v-2a763b36] {
  position: relative;
  display: grid;
  width: 100%;
  max-width: 420px;
...
.index-wrapper .grid-container .head-controls .search-controls .search-box[data-v-2a763b36] {
  width: 100%;
  padding: 8px;
...
.index-wrapper .grid-container .head-controls .search-controls .search-button[data-v-2a763b36] {
  border: none;
...
.index-wrapper .grid-container .head-controls .search-controls .search-suggestions[data-v-2a763b36] {
  position: absolute;
  z-index: 1;
  top: 100%;
  display: flex;
...
.index-wrapper .grid-container .head-controls .search-controls .search-suggestions .search-elem[data-v-2a763b36] {
  display: flex;
  overflow: hidden;
  box-sizing: border-box;
  padding: 0;
  ...
  border: none;
  border-radius: 0;
  animation: stretch-2a763b36 0.2s cubic-bezier(0.22, 0.61, 0.36, 1);
  gap: 8px;
  text-align: justify;
}
@keyframes stretch-2a763b36 {
0% {
    padding: 4px 8px;
}
100% {
...
.index-wrapper .grid-container .head-controls .search-controls .search-suggestions .search-elem .sugg-img[data-v-2a763b36] {
  width: 42px;
  height: 42px;
  border-radius: 8px;
}
.index-wrapper .grid-container .head-controls .search-controls .search-suggestions .search-elem .sugg-content[data-v-2a763b36] {
  position: relative;
  display: flex;
...
.index-wrapper .grid-container .head-controls .search-controls .search-suggestions .search-elem .sugg-content .sugg-title[data-v-2a763b36] {
  overflow: hidden;
  margin: 0;
  font-size: 14px;
  font-weight: var(--font-weight-bold);
...
.index-wrapper .grid-container .head-controls .search-controls .search-suggestions .search-elem .sugg-content .sugg-desc[data-v-2a763b36] {
  overflow: hidden;
  margin: 0;
  color: var(--light-fore);
  font-size: 12px;
...
.index-wrapper .grid-container .profile-menu-container[data-v-2a763b36] {
  position: absolute;
  z-index: 1;
}
.index-wrapper .grid-container .profile-menu-container .curr-user[data-v-2a763b36] {
  position: fixed;
  top: 24px;
  left: 24px;
  overflow: hidden;
...
.index-wrapper .grid-container .profile-menu-container .profile-menu[data-v-2a763b36] {
  top: 64px;
  left: 24px;
}
.index-wrapper .grid-container .config-menu-container[data-v-2a763b36] {
  position: absolute;
  z-index: 1;
  display: flex;
}
.index-wrapper .grid-container .config-menu-container .config-menu-btn[data-v-2a763b36] {
  position: fixed;
  top: 24px;
  right: 24px;
  height: 32px;
...
.index-wrapper .grid-container .config-menu-container .config-menu-btn[data-v-2a763b36]:hover {
  background-color: var(--default-background);
}
.index-wrapper .grid-container .config-menu-container .config-menu-btn[data-v-2a763b36]:active {
  background-color: var(--default-hover);
}
.index-wrapper .grid-container .config-menu-container .config-menu[data-v-2a763b36] {
  top: 64px;
  right: 24px;
  opacity: 1;
}
.index-wrapper .grid-container .signed-count[data-v-2a763b36] {
  font-weight: var(--font-weight-bold);
}
.index-wrapper .grid-container .block-panel.followed[data-v-2a763b36] {
  margin-left: auto;
}
.index-wrapper .grid-container .followed-container[data-v-2a763b36] {
  margin-top: -16px;
}
.index-wrapper .grid-container .followed-container .followed-list[data-v-2a763b36] {
  display: flex;
  flex-wrap: wrap;
  padding: 8px;
  border-radius: 12px;
...
.index-wrapper .grid-container .followed-container .followed-list .followed-btn[data-v-2a763b36] {
  display: flex;
  align-items: center;
  padding: 6px 8px;
  border-radius: 12px;
...
.index-wrapper .grid-container .followed-container .followed-list .followed-btn .signed[data-v-2a763b36] {
  color: green;
  font-weight: var(--font-weight-bold);
}
.index-wrapper .grid-container .followed-container .followed-list .followed-btn .forum-level[data-v-2a763b36] {
  min-width: 24px;
  padding: 0 2px;
  border-radius: 24px;
  font-weight: var(--font-weight-bold);
...
.index-wrapper .grid-container .topic-list[data-v-2a763b36] {
  display: grid;
  grid-gap: 4px;
  gap: 4px;
...
.index-wrapper .grid-container .topic-list .topic-btn[data-v-2a763b36] {
  display: flex;
  width: 100%;
  height: 100%;
  align-items: center;
...
.index-wrapper .grid-container .topic-list .topic-btn .topic-img[data-v-2a763b36] {
  width: 72px;
  border-radius: 12px;
}
.index-wrapper .grid-container .topic-list .topic-btn .topic-content[data-v-2a763b36] {
  display: flex;
  flex-flow: column wrap;
  gap: 4px;
  text-align: justify;
}
.index-wrapper .grid-container .topic-list .topic-btn .topic-content .topic-title[data-v-2a763b36] {
  display: flex;
  align-items: center;
  gap: 6px;
}
.index-wrapper .grid-container .topic-list .topic-btn .topic-content .topic-title [class^=topic-rank][data-v-2a763b36] {
  padding: 0 4px;
  border-radius: 4px;
...
.index-wrapper .grid-container .topic-list .topic-btn .topic-content .topic-title .topic-name[data-v-2a763b36] {
  font-size: 16px;
  font-weight: var(--font-weight-bold);
}
.index-wrapper .grid-container .topic-list .topic-btn .topic-content .topic-desc[data-v-2a763b36] {
  color: var(--light-fore);
  font-size: 14px;
}
.index-wrapper .masonry-container[data-v-2a763b36] {
  display: flex;
  width: calc(100% - 32px);
  max-width: var(--content-max);
  box-sizing: border-box;
...
.index-wrapper .masonry-container .feeds-container[data-v-2a763b36] {
  width: 100%;
  margin: auto;
}
@keyframes feeds-in-2a763b36 {
0% {
    transform: scale(0.72);
}
100% {
...
@keyframes refresh-btn-in-2a763b36 {
0% {
    padding: 0 18px;
    opacity: 0;
}
...
.index-wrapper .masonry-container .feeds-container .feeds-refresh-btn[data-v-2a763b36] {
  position: fixed;
  z-index: 1;
  bottom: 24px;
  left: 50%;
  ...
  border-width: 2px;
  border-radius: 16px;
  animation: refresh-btn-in-2a763b36 0.4s ease;
...
.index-wrapper .masonry-container .feeds-container .feeds-refresh-btn .icon[data-v-2a763b36] {
  font-size: 18px;
}
.index-wrapper .masonry-container .post-elem[data-v-2a763b36] {
  animation: feeds-in-2a763b36 0.4s cubic-bezier(0.18, 0.89, 0.32, 1.2);
}
.index-wrapper .masonry-container .post-elem[data-v-2a763b36]:not(:hover):not(:active):not(:focus) {
  box-shadow: none;
}
.index-wrapper .masonry-container .empty-container .no-feed-content[data-v-2a763b36] {
  color: var(--minimal-fore);
  font-size: small;
  text-align: center;
...
#thread-editor #thread-editor-exit[data-v-5397d44f] {
  margin-left: auto;
  font-size: 18px;
}
#thread-editor #thread-editor-exit[data-v-5397d44f]:not(:hover):not(:active):not(:focus) {
  box-shadow: none;
}
#thread-editor .title-editor[data-v-5397d44f] {
  width: 100%;
  flex-grow: 1;
  border-width: 3px;
  background-color: transparent;
...
#thread-editor h1[data-v-5397d44f] {
  margin-right: auto;
}
#thread-editor #thread-editor-slot[data-v-5397d44f] {
  width: 100%;
  flex-shrink: 2;
}
#thread-editor #thread-editor-toolbar[data-v-5397d44f] {
  display: flex;
  width: 100%;
  align-items: center;
}
#thread-editor #thread-editor-toolbar #thread-editor-submit[data-v-5397d44f] {
  padding: 4px 12px;
  margin-left: auto;
  font-size: 16px;
  font-weight: var(--font-weight-bold);
...
html.dark-theme .blur-effect[data-v-465a0f6d] {
  -webkit-backdrop-filter: blur(24px) brightness(0.8);
          backdrop-filter: blur(24px) brightness(0.8);
}.nav-reveal-zone[data-v-6bd45f86] {
  position: fixed;
  z-index: 1199;
  top: 0;
  right: 0;
...
html.dark-theme #nav-bar[data-v-6bd45f86] {
  box-shadow: 0 2px 12px rgba(0, 0, 0, 0.4);
}
body[no-scrollbar] #nav-bar[data-v-6bd45f86] {
  right: var(--scrollbar-width);
}
#nav-bar.fold[data-v-6bd45f86] {
  transform: translateY(calc(-100% - 16px));
  opacity: 0;
}
#nav-bar.fold.revealed[data-v-6bd45f86] {
  transform: translateY(0);
  opacity: 1;
}
#nav-bar #nav-container[data-v-6bd45f86] {
  display: flex;
  width: 100%;
  height: 100%;
  align-items: center;
...
#nav-bar #nav-container .left-container .nav-brand[data-v-6bd45f86] {
  color: var(--default-fore);
  font-size: 15px;
  font-weight: var(--font-weight-bold);
  opacity: 0.5;
...
#nav-bar #nav-container .right-container[data-v-6bd45f86] {
  display: flex;
  align-items: center;
  gap: 4px;
}
#nav-bar #nav-container .right-container .avatar-button .nav-avatar[data-v-6bd45f86] {
  width: 28px;
  height: 28px;
  border-radius: 6px;
  -o-object-fit: cover;
...
#nav-bar #nav-container .right-container .avatar-button:hover > .nav-avatar[data-v-6bd45f86] {
  box-shadow: 0 0 0 2px var(--tieba-theme-color);
}
.nav-icon-button[data-v-6bd45f86] {
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 6px;
...
.nav-icon-button .nav-svg[data-v-6bd45f86] {
  width: 18px;
  height: 18px;
}
.nav-icon-button[data-v-6bd45f86]:hover {
  background-color: var(--default-hover);
  color: var(--default-fore);
}
.menu-trigger[data-v-6bd45f86] {
  position: relative;
  background-color: transparent;
}
.menu-trigger[data-v-6bd45f86]::after {
  content: "";
  position: absolute;
  top: 100%;
  left: 0;
...
.nav-menu.visible[data-v-6bd45f86] {
  visibility: visible;
  opacity: 1;
  pointer-events: auto;
}:root {\r
...
(function () {
  ...
  (function(_2, vue, userView, libelemental2, marked2) {
    ...
    const _hoisted_1$i = { class: "trigger-text" };
    const _hoisted_2$f = {
      key: 0,
      class: "select-popover"
    };
    const _hoisted_3$c = { class: "select-list" };
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createElementBlock("div", {
            ...
            vue.createElementVNode("button", {
              ...
              vue.createElementVNode("span", _hoisted_1$i, vue.toDisplayString(currentText.value), 1),
            ...
            vue.createVNode(vue.Transition, { name: "setting-select-pop" }, {
              default: vue.withCtx(() => [
                open.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$f, [
    ...
    const SettingSelect = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-4901a01f"]]);
    const _hoisted_1$h = ["aria-checked", "disabled"];
    ...
    const SettingSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-6d7081fc"]]);
...
${errBody}`;
    ...
    const _hoisted_4$9 = { class: "script-info" };
    const _hoisted_5$8 = { class: "author-info" };
    const _hoisted_6$5 = { class: "version" };
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$g, [
            vue.createElementVNode("div", _hoisted_2$e, [
              vue.createElementVNode("div", _hoisted_3$b, vue.toDisplayString(vue.unref(MainTitle)), 1)
            ]),
            vue.createElementVNode("div", _hoisted_4$9, [
              vue.createElementVNode("div", _hoisted_5$8, [
                vue.createElementVNode("div", _hoisted_6$5, "v" + vue.toDisplayString(vue.unref(scriptInfo).script.version), 1),
    ...
    const AboutDetail = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-4060d874"]]);
    const _hoisted_1$f = {
      key: 0,
    ...
    const _sfc_main$h = /* @__PURE__ */ vue.defineComponent({
      ...
      setup(__props) {
        ...
        return (_ctx, _cache) => {
          var _a, _b, _c, _d;
          return release.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$f, [
            isLatest.value !== undefined ? (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.createElementVNode("div", _hoisted_3$a, vue.toDisplayString(isLatest.value ? "当前是最新版本" : "检测到新版本"), 1)
            ...
            !isLatest.value ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
              vue.createElementVNode("div", _hoisted_4$8, [
                ...
                ((_b = release.value) == null ? undefined : _b.prerelease) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_6$4, "预览版")) : vue.createCommentVNode("", true)
              ]),
    ...
    const AboutUpdate = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-8b81bea5"]]);
    const _hoisted_1$e = { class: "layout-custom-back" };
    const _hoisted_2$c = { class: "head-row" };
    const _hoisted_3$9 = { class: "head-actions" };
    const _hoisted_4$7 = { class: "preview-row" };
    ...
    const LayoutCustomBack = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-bc28201e"]]);
    ...
    const ColorPicker = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-d258c23f"]]);
    ...
    const ThemeColor = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-b4e9e941"]]);
      ...
      setup(__props, {
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createBlock(vue.unref(userView.UserDialog), vue.normalizeProps(vue.guardReactiveProps(dialogOpts)), {
            default: vue.withCtx(() => {
              var _a, _b, _c, _d;
              return [vue.createElementVNode("div", _hoisted_1$b, [vue.createElementVNode("aside", _hoisted_2$a, [vue.createElementVNode("header", _hoisted_3$8, [_cache[1] || (_cache[1] = vue.createElementVNode("h1", {
                class: "sidebar-title"
                ...
                placeholder: "搜索设置..."
              }, null, 8, ["modelValue", "onUpdate:modelValue"])]), vue.createElementVNode("nav", _hoisted_4$6, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(userSettings), (main2) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  key: main2.name,
                  class: "nav-group"
                }, [vue.createElementVNode("div", _hoisted_5$5, [vue.createElementVNode("span", _hoisted_6$3, vue.toDisplayString(main2.icon), 1), vue.createElementVNode("span", _hoisted_7$3, vue.toDisplayString(main2.name), 1)]), vue.createElementVNode("ul", _hoisted_8$2, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(main2.sub, (sub) => {
                  var _a2, _b2;
                  return vue.openBlock(), vue.createElementBlock("li", {
                    key: sub.name,
                ...
                }, null, 32))])) : content && isSimpleRow(content) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_19$1, [vue.createElementVNode("div", _hoisted_20$1, [content.title ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_21$1, vue.toDisplayString(content.title), 1)) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(resolveSimpleDesc(content), (line, idx) => {
                  return vue.openBlock(), vue.createElementBlock("p", {
                    key: idx,
                    class: "row-desc"
                  }, vue.toDisplayString(line), 1);
                }), 128))]), vue.createElementVNode("div", _hoisted_22$1, [content.widgets[0].type === "toggle" ? (vue.openBlock(), vue.createBlock(SettingSwitch, {
                  key: 0,
                ...
                }, null, 8, ["data", "default-value", "onChange"])) : vue.createCommentVNode("", true)])])) : content ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_23$1, [content.title || content.description ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_24$1, [content.title ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_25, vue.toDisplayString(content.title), 1)) : vue.createCommentVNode("", true), content.description ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_26, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(splitLines(content.description), (line, idx) => {
                  return vue.openBlock(), vue.createElementBlock("p", {
                    key: idx
                  }, vue.toDisplayString(line), 1);
    ...
    const Settings = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-343efbfc"]]);
    ...
    const BlockPanel = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render]]);
    /**
     * Flex Masonry
     * @author @HacksawBlade
     * @version 1.1
    ...
    const HeaderProgress = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-782eb887"]]);
      ...
      setup(__props) {
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createBlock(vue.unref(userView.UserDialog), {
            ...
            }, null, 8, ["modelValue"])]), vue.createElementVNode("div", _hoisted_3$7, [vue.createVNode(vue.unref(userView.UserCheck), {
    ...
    const ShieldEditor = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-bf172916"]]);
    const _hoisted_1$8 = {
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$8, [shieldListRef.value.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$8, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(shieldListRef.value, (sh, index2) => {
            return vue.openBlock(), vue.createBlock(vue.unref(userView.UserButton), {
              ...
              default: vue.withCtx(() => [vue.createElementVNode("div", _hoisted_3$6, vue.toDisplayString(sh.scope === "content" ? "chat" : "account_circle"), 1), vue.createElementVNode("p", _hoisted_4$5, vue.toDisplayString(sh.content), 1)]),
              _: 2
            }, 1032, ["class", "onClick"]);
            ...
            _: 1
          })])) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$4, "当前没有记录屏蔽规则")), vue.createElementVNode("div", _hoisted_6$2, [vue.createVNode(vue.unref(userView.UserTextbox), {
    ...
    const moduleShieldVue = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-5a687904"]]);
    const index$f = {
      id: "shield",
      name: "贴吧屏蔽",
      author: "锯条",
    ...
    const _hoisted_1$7 = { class: "image-loading-spinner" };
    const _hoisted_2$7 = ["src"];
    const _hoisted_3$5 = { class: "zoom-size" };
    const _hoisted_4$4 = { class: "bottom-controls-container" };
    const _hoisted_5$3 = ["data-lazyload", "onClick"];
    const MIN_SIZE = 0.1;
    const MAX_SIZE = 8;
      ...
      setup(__props) {
        ...
        const imageStyle = vue.computed(() => {
          ...
          return {
            ...
            transition: disableImageTransition.value ? "none" : vliMode.value ? "width 0.4s ease, height 0.4s ease, transform 0.4s ease, left 0s, top 0.1s ease-out" : "width 0.4s ease, height 0.4s ease, transform 0.4s ease, left 0s, top 0s"
          };
        });
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("div", {
                ...
                vue.createElementVNode("div", {
                  ...
                  vue.withDirectives(vue.createElementVNode("div", _hoisted_1$7, null, 512), [
                ...
                vue.createElementVNode("div", {
                  ...
                  vue.createElementVNode("span", _hoisted_3$5, vue.toDisplayString(vue.unref(_2).round(scale.value * 100) + "%"), 1),
    ...
    const ImagesViewer = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-17710c27"]]);
    ...
    const _hoisted_6$1 = { class: "bottom-controls" };
          ...
          return vue.openBlock(), vue.createBlock(vue.unref(userView.UserButton), {
            ...
            default: vue.withCtx(() => [
              ...
              vue.createElementVNode("div", _hoisted_1$6, [
                ...
                props.post.content && props.post.content !== " " ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_3$4, vue.toDisplayString(props.post.content), 1)) : vue.createCommentVNode("", true)
              ]),
              props.post.images.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$3, [
    ...
    const PostContainer = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-8fa74492"]]);
    const maxFeeds = 1e3;
    ...
    const _hoisted_3$3 = { class: "head-controls" };
    const _hoisted_4$2 = { class: "search-controls" };
    const _hoisted_5$1 = { class: "search-suggestions" };
        ...
        return (_ctx, _cache) => {
          return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$5, [
            vue.createElementVNode("div", _hoisted_2$5, [
              ...
              vue.unref(followed) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_10, [
    ...
    const Home = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-2a763b36"]]);
    ...
    const ThreadEditor = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-5397d44f"]]);
...
.lzl_edui_dialog_container .inde_edui_popup_caret {
  display: none;
    ...
    const navBarVue = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6bd45f86"]]);
